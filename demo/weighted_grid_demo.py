import random
from mazes.weighted_grid import WeightedGrid
...
new_grid.to_png(file_name='weighted_original.png', inset=0.2, cell_size=60, line_thickness=2)  # noqa: E501
lava = random.choice(new_grid.distances.cells)
lava.weight = 50
new_grid.distances = start.distances.path_to(finish)
new_grid.to_png(file_name='weighted_rerouter.png', inset=0.2, cell_size=60, line_thickness=2)  # noqa: E501
